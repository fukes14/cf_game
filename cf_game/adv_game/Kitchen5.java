...
*
* Methods:
* Kitchen5 - Creates frame to let the user search for supplies.
...
public class Kitchen5 extends JFrame
{
	//class constants
	...
	//class variable
	private MainMenuK5 mainMenu; //The frame start to return to
	private Street3 street;      //The street is the leaves the kitchen
