...
*
* Methods:
* Kitchen2 - Creates frame to let the user search for supplies.
...
public class Kitchen2 extends JFrame
{
	//class constants
	...
	//class variable
	private MainMenuK2 mainMenu; //The frame start to return to
