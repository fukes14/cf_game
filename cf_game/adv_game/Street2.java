...
public class Street2 extends JFrame
{
	...
	//class variable
	private MainMenuS2 mainMenu; //The menu the user chooses options from
	private Street3 street;      //The next street the user can explore
	...
	private Kitchen4 k4;         //The 4 kitchen
	private Church church;       //The church
	...
	private Street1 streetP;     //Frame to return to past street
	...
	private void attack()
	{
		...
		zom.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				//Display the amount of energy costed
				bottomLabel.setText("Zombie hp: " + Zombie2.getVal());
	...
	***********************************************************/
	private void setC1()
	{
		...
		//Create object of JButton and set label on it
		c1 = new JButton(new ImageIcon("h4.jpg"));
		...
		//Set bounds of the Button
		c1.setBounds(260, 160, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setC3()
	{
		...
		//Create object of JButton and set label on it
		c3 = new JButton(new ImageIcon("church.jpg"));
		...
		//Set bounds of the Button
		c3.setBounds(500, 70, size.width - 40, size.height - 15);
	...
	***********************************************************/
	...
	{
		//Initialize mainMenu
		mainMenu = new MainMenuS2(this);

		//Initialize next street
		street = new Street3(this);

		//Initialize kitchen4
		k4 = new Kitchen4(this);

		//Initialize church
		church = new Church(this);
