...
*    Appt the user can search.
*
* Methods:
* Appt     - Creates frame to let the user search for supplies.
...
public class Appt extends JFrame
{
	...
	//class variable
	private MainMenuA mainMenu;  //The frame start to return to
