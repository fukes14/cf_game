...
*
* Methods:
* Sanctuary     - Creates the frame to tell the user they lost.
...
* reset         - Resets the games components.
**********************************************************/
import java.awt.*;
...
public class Sanctuary extends JFrame
{
	...
	*    they win and offers a new game or quit.
	*
	* BEGIN Sanctuary
	...
	***********************************************************/
	private void setStoryLabel()
	{
		...
		//Set bound of the label
		storyLabel.setBounds((450 - size.width) / 2, 40, size.width, size.height);
	...
	***********************************************************/
	private void setNewg()
	{
		...
		//Set bounds of the Button
		newg.setBounds((480 - size.width - 20) / 2, 140, size.width - 40, size.height - 18);
	...
	***********************************************************/
	private void setQuit()
	{
		...
		//Set bounds of the Button
		quit.setBounds((460 - size.width) / 2, 230, size.width - 40, size.height - 10);
	...
	* Course/Section : CSC-264
	*
	* Program Description: Resets the games components.
	*
	* BEGIN reset
	*    Reset the energy value
	*    Reset the number of coins
