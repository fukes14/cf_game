...
*
* Methods:
* MainMenuS3 - The frame that is displayd the menu in street1.
...
public class MainMenuS3 extends JFrame
{
	//local constants
	...
	private Street3 s1;         //The frame to resume to
	...
	* END MainMenuS3
	**********************************************************/
	public MainMenuS3(Street3 temp)
	{
		//local constants
