...
public class Kitchen6 extends JFrame
{
	//class constants
	...
	//class variable
	private MainMenuK6 mainMenu; //The frame start to return to
	private Street4 street;      //The street is the leaves the kitchen
