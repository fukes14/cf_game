...
*
* Methods:
* Kitchen4 - Creates frame to let the user search for supplies.
...
public class Kitchen4 extends JFrame
{
	//class constants
	...
	//class variable
	private MainMenuK4 mainMenu; //The frame start to return to
