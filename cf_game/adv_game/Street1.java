/**********************************************************
* Program Name   : Street1
* Author         : Cameron Fukes
* Date           : April 20, 2018
* Course/Section : CSC-264
*
* Program Description: The frame that holds the first 3
*    houses to explore.
*
* Methods:
* QuitMenu      - Instantiates instance data and runs the frame.
...
public class Street1 extends JFrame
{
	//class constants

	//class variable
	private MainMenuS1 mainMenu; //The menu the user chooses options from
	private Street2 street;      //The next street the user can explore
	...
	private Kitchen1 k1;         //The first kitchen
	private Kitchen2 k2;         //The second kitchen
	private Kitchen3 k3;         //The third kitchen
	...
	private JButton c1, c2;      //The different houses button
	private JButton c3, c4;      //The different houses button
	...
	private void attack()
	{
		...
		zom.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				//Display the amount of energy costed
				bottomLabel.setText("Zombie hp: " + Zombie1.getVal());
	...
	***********************************************************/
	private void setC1()
	{
		...
		//Create object of JButton and set label on it
		c1 = new JButton(new ImageIcon("h1.jpg"));
		...
		//Set bounds of the Button
		c1.setBounds(130, 170, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setC2()
	{
		...
		//Create object of JButton and set label on it
		c2 = new JButton(new ImageIcon("h2.jpg"));
		...
		//Set bounds of the Button
		c2.setBounds(350, 160, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setC3()
	{
		...
		//Create object of JButton and set label on it
		c3 = new JButton(new ImageIcon("h3.jpg"));
		...
		//Set bounds of the Button
		c3.setBounds(575, 155, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setNextStreet()
	{
		...
		//Set bounds of the Button
		nextStreet.setBounds(800, 210, size.width - 40, size.height - 15);
	...
	***********************************************************/
	...
	{
		//Initialize mainMenu
		mainMenu = new MainMenuS1(this);

		//Initialize next street
		street = new Street2(this);

		//Initialize kitchen1
		k1 = new Kitchen1(this);

		//Initialize kitchen2
		k2 = new Kitchen2(this);

		//Initialize kitchen3
		k3 = new Kitchen3(this);
