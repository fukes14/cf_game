...
*
* Methods:
* MainMenuK3 - The frame that is displayed when Church menu is selected.
...
public class MainMenuC extends JFrame
{
	//class constants
	...
	private Church k3;          //The frame to resume to
