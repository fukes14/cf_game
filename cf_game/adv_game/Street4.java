...
*
* Methods:
* Street4       - Instantiates instance data and runs the frame.
...
public class Street4 extends JFrame
{
	//class constants

	//class variable
	private MainMenuS4 mainMenu; //The menu the user chooses options from
	...
	private Kitchen6 k4;         //The 5 kitchen
	private Sanctuary win;       //The good end
	...
	private Street3 streetP;     //Frame to return to past street
	...
	private void attack()
	{
        ...
        ActionListener listener = new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
				...
				if(zom.isEnabled())
				{
					...
					//Set the updating bounds of the button
					zom.setBounds(moves, 395, size.width - 50, size.height - 20);
		...
		zom.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				//Display the amount of energy costed
				bottomLabel.setText("Zombie hp: " + Zombie4.getVal());
	...
	***********************************************************/
	private void setC1()
	{
		...
		//Create object of JButton and set label on it
		c1 = new JButton(new ImageIcon("h6.jpg"));
		...
		//Set bounds of the Button
		c1.setBounds(325, 158, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setC3()
	{
		...
		//Create object of JButton and set label on it
		c3 = new JButton(new ImageIcon("sanctuary.jpg"));
		...
		c3.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				//Generate the time until attack
				time = rand.nextInt(10) - Coin.getVal();

				System.out.print("coins: " + Coin.getVal() + " time: " + time);
		...
		c3.addMouseListener(new java.awt.event.MouseAdapter()
		{
			...
			{
				//Display the amount of energy costed
				bottomLabel.setText("If you go get let in here you will survive");
		...
		//Set bounds of the Button
		c3.setBounds(600, 105, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setPreStreet()
	{
		...
		//Set bounds of the Button
		prevStreet.setBounds(175, 200, size.width - 40, size.height - 15);
	...
	***********************************************************/
	...
	{
		//Initialize mainMenu
		mainMenu = new MainMenuS4(this);

		//Initialize kitchen5
		k4 = new Kitchen6(this);
