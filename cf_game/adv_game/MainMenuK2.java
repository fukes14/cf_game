...
*
* Methods:
* MainMenuK2 - The frame that is displayed when kitchen menu is selected.
...
public class MainMenuK2 extends JFrame
{
	//class constants
	...
	private Kitchen2 k2;        //The frame to resume to
	...
	* END MainMenuK2
	**********************************************************/
	public MainMenuK2(Kitchen2 temp)
	{
		//local constants
	...
	***********************************************************/
	private void setResume()
	{
		...
		//Set bounds of the Button
		resume.setBounds((WIDTH - size.width) / 2, 20, size.width - 40, size.height - 15);
