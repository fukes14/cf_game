/**********************************************************
* Program Name   : Kitchen1
* Author         : Cameron Fukes
* Date           : April 20, 2018
* Course/Section : CSC-264
*
* Program Description: The frame that is displayed the
*    kitchen the user can search.
*
* Methods:
* Kitchen1 - Creates frame to let the user search for supplies.
...
public class Kitchen1 extends JFrame
{
	//class constants
	private final int WATER = 25; //The value for finding water
	private final int FOOD  = 30; //The value for finding food

	//class variable
	private MainMenuK1 mainMenu; //The frame start to return to
	private Street1 street;      //The street is the leaves the kitchen
	...
	*          Set ending frame visible true
	*          Set default close operation
	*         Set kitchen frame visible false
	*       END if
	*       Disable button
	*    END actionlistener
	...
	***********************************************************/
	private void setC1()
	{
		...
		//Create object of JButton and set label on it
		c1 = new JButton(new ImageIcon("c1.jpg"));
	...
	***********************************************************/
	private void setC2()
	{
		...
		//Create object of JButton and set label on it
		c2 = new JButton(new ImageIcon("c2.jpg"));
		...
		//Set bounds of the Button
		c2.setBounds(205, 303, size.width - 40, size.height - 15);
	...
	***********************************************************/
	private void setC3()
	{
		...
		//Create object of JButton and set label on it
		c3 = new JButton(new ImageIcon("c3.jpg"));
		...
		//Set bounds of the Button
		c3.setBounds(110, 310, size.width - 40, size.height - 15);
