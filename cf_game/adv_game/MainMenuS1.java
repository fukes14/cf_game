/**********************************************************
* Program Name   : MainMenuS1
* Author         : Cameron Fukes
* Date           : April 20, 2018
* Course/Section : CSC-264
*
* Program Description: The frame that is displayed when
*    the menu in Street1 is selected.
*
* Methods:
* MainMenuS1 - The frame that is displayd the menu in street1.
...
public class MainMenuS1 extends JFrame
{
	//local constants
	...
	private Street1 s1;         //The frame to resume to
	...
	* END MainMenuS1
	**********************************************************/
	public MainMenuS1(Street1 temp)
	{
		//local constants
