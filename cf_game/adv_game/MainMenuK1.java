/**********************************************************
* Program Name   : MainMenuK1
* Author         : Cameron Fukes
* Date           : April 20, 2018
* Course/Section : CSC-264
*
* Program Description: The frame that is displayed when
*    the menu in kitchen is selected.
*
* Methods:
* MainMenuK1 - The frame that is displayed when kitchen menu is selected.
...
public class MainMenuK1 extends JFrame
{
	//class constants
	...
	private Kitchen1 k1;        //The frame to resume to
	...
	* END MainMenuK1
	**********************************************************/
	public MainMenuK1(Kitchen1 temp)
	{
		//local constants
		...
		//Set bound of the label
		title.setBounds((WIDTH - size.width) / 2, 40, size.width, size.height);
		...
		addWindowListener(new WindowAdapter()
		{
			...
			{
				//Set kitchen frame visible true
				k1.setVisible(true);
...
//    20, size.width - 40, size.height - 20);
//    140, size.width - 40, size.height - 18);
//    230, size.width - 40, size.height - 10);
}//END MainMenuK1