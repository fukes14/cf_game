/**********************************************************
* Program Name   : MainMenuS2
* Author         : Cameron Fukes
* Date           : April 20, 2018
* Course/Section : CSC-264
*
* Program Description: The frame that is displayed when
*    the menu in Street2 is selected.
*
* Methods:
* MainMenuS2 - The frame that is displayd the menu in street1.
...
public class MainMenuS2 extends JFrame
{
	//local constants
	...
	private Street2 s2;         //The frame to resume to
	...
	* END MainMenuS2
	**********************************************************/
	public MainMenuS2(Street2 temp)
	{
		//local constants
