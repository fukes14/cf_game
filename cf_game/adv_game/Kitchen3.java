...
*
* Methods:
* Kitchen3 - Creates frame to let the user search for supplies.
...
public class Kitchen3 extends JFrame
{
	//class constants
	...
	//class variable
	private MainMenuK3 mainMenu; //The frame start to return to
